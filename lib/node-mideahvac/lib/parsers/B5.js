...
exports.parser = (data, options = {}) => {
  ...
  // B5 consists of variable length capability records. Unknown record IDs are
  // intentionally not mapped to controls, but raw/analog debug output can expose
  // every byte so changing capability blocks can be compared in logs.
  let i = 2;
